...
for model_name_ in model_names:
    for retriever_name_ in retriever_names:
        for corpus_name_ in corpus_names:
            output_name_ = "MedMCQA(Ophthalmology)+[rationale_query]+" + model_name_ + "+" + retriever_name_ + "+" + corpus_name_
            print('---', output_name_, '---')
            ...
            with open('../data/results_oph/MedMCQA_ophthalmology_val_result.json', 'w') as file:
                json.dump(data, file)